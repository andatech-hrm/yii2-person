...
<div class="positions_old-form">
    ...
    <h2 class="page-header dark" style="margin-top: 0; padding-top: 9px;">
        ...
        <button type="button" class="pull-right positions_old-add-item btn btn-success btn-xs"><i class="fa fa-plus"></i> <?=Yii::t('andahrm/person', 'Create Position Old')?></button>
    </h2> 
