...
?>  
        ...
        <?php echo $form->field($model,'level',['options'=>['class'=>'form-group col-sm-3']])->textInput();?>
         
         <?php 
         #echo  $form->field($model,'status',['options'=>['class'=>'form-group col-sm-2']])->dropDownList(PersonPositionSalary::getItemStatus());
         ?>
