...
?>
<div class="row">
    <?= $form->field($model, "year_start", ['options' => ['class' => 'form-group col-sm-2']])->widget(\andahrm\datepicker\YearBuddhist::className()) ?>
    <?= $form->field($model, "year_end", ['options' => ['class' => 'form-group col-sm-2']])->widget(\andahrm\datepicker\YearBuddhist::className()) ?>
