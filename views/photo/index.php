...
<div class="photo-index">
            ...
            <div class="image view view-first">
                ...
                <div class="mask">
                    ...
                    <div class="tools tools-bottom">
                        ...
                        <a href="<?= Url::to(['update', 'user_id'=>$photo->user_id, 'year' => $photo->year]); ?>" class="btn-load-form" data-toggle="modal" data-target="#<?= $modal->id; ?>" title="<?= Yii::t('andahrm', 'Update') ?>"><i class="fa fa-pencil"></i></a>
                        <a href="<?= Url::to(['delete', 'user_id'=>$photo->user_id, 'year' => $photo->year]); ?>" data-confirm="<?= Yii::t('yii', 'Are you sure you want to delete this item?') ?>" title="<?= Yii::t('andahrm', 'Delete') ?>" data-method="post"><i class="fa fa-trash"></i></a>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-55">
        <div class="thumbnail">
            <div class="image view view-first">
                <a href="<?= Url::to(['create']); ?>" class="btn btn-success btn-block btn-load-form" style="height:100%;font-size: -webkit-xxx-large;display: flex; align-items: center; justify-content: center;" data-toggle="modal" data-target="#<?= $modal->id; ?>" title="<?= Yii::t('andahrm', 'Create') ?>"><i class="fa fa-plus-circle"></i></a>
            </div>
            <div class="caption text-center">
