...
$this->title = Yii::t('andahrm', 'Print');
...
<table class="table-print">
        <thead>
            <tr class="header-labels">
                <th class="text-center" style="width: 2cm;"><?= Yii::t('andahrm/person', 'Date Defect'); ?></th>
...
<table style="border-collapse: collapse;">
    ...
    //echo $this->render('_position-salary',['models'=>$dataPositionSaraly->getModels(),'rowNum' => $rowNum]);
    ?>